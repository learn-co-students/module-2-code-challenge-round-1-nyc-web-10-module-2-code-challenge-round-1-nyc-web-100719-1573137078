...
heroines = [
  ...
  {name:"Carol Danvers", super_name:"Captain Marvel", power_id: 4 },
  ...
  {name:"Elektra Natchios", super_name:"Elektra", power_id: 3 },
  {name:"Bailey Wood", super_name:"Elektra", power_id: 3 },
